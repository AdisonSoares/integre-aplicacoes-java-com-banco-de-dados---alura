...
public class CadastroDePedido {
	...
	public static void main(String[] args) {
		...
		pedido1.adicionarItem(new ItemPedido(quantidadeProduto2, pedido1, produto2));

		Pedido pedido2 = new Pedido(cliente);
		pedido2.adicionarItem(new ItemPedido(quantidadeProduto3, pedido2, produto3));
		...
		System.out.println("Valor total da venda: R$" + totalVendido);
	...
	private static void popularBancoDeDados() {
		...
		Produto dell = new Produto("Dell", "Vostro", new BigDecimal("5000"), informatica);
